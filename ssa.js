  ...
  fetch(
    ...
    .then((data) => {
      ...
      data.data.forEach((news) => {
        ...
        if (news.ButtonView || news.ButtonEdit || news.ButtonDelete) {
          manage.innerHTML = `
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form>
                      <div class="mb-3">
                        <label for="news-name" class="col-form-label">ชื่อเรื่อง</label>
                        <input type="text" id="news-name-${news.NewsId}" value="${dataName}" disabled>
                      </div>
                      <div class="mb-3">
                        <label for="detail-text" class="col-form-label">เนื้อหา</label>
                      ...
                      <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="${modalSwitchId}">Switch Label</label>
                      </div>
                    </form>
                  </div>
